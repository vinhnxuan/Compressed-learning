...
def setup_model(x, num_measurement,keep_prob):
    ...
    with tf.variable_scope('fully_connected01_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('fully_connected02_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('conv22_new_64') as scope:
    ...
    with tf.variable_scope('conv3_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('conv4_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('conv5_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('fully_connected1_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('fully_connected2_new_64',reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('fully_connected3_new_64',reuse=tf.AUTO_REUSE):
