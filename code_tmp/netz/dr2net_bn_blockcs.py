...
W_conv03 = weight_variable([1, 1, layer_num, conv_win*conv_win])
b_conv03 = bias_variable([conv_win*conv_win])

h_conv03 = tf.nn.relu(conv2d(h_conv01, W_conv03) + b_conv03)

#W_conv02 = weight_variable([1, 1, 100, 16*16])
#b_conv02 = bias_variable([16*16])
#
#h_conv02 = tf.nn.relu(conv2d(h_conv03, W_conv02) + b_conv02)


h_trans=tf.transpose(h_conv03,[1,2,0,3])
