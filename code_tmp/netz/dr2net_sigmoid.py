...
h_fc02 = tf.nn.sigmoid(tf.matmul(h_fc01, W_fc02)+b_fc02)
...
h_conv4 = tf.nn.tanh(conv2d(h_conv3_add, W_conv4) + b_conv4)
...
y = tf.nn.tanh(conv2d(h_conv5, W_conv6) + b_conv6) + h_conv3_add
