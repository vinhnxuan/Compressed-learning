...
def setup_model(x, num_measurement):
    ...
    with tf.variable_scope('fully_connected01_128',reuse=tf.AUTO_REUSE):
        ...
        h_fc02 = tf.nn.relu(tf.matmul(tf.nn.relu(h_fc01), W_fc02)+b_fc02)
    
    
    x_4 = tf.reshape(h_fc01, [-1, _IMAGE_CHANNELS, num_measurement])
    ...
    return x_4, softmax_linear, global_step, y_pred_cls, m_coherence, W_fc01
